          ...
          return (
            <div key={index} className='mini'
              ...
              <img src={item.imgSource} alt={item.dataName}
                data-owncode={item.dataOwncode} data-code={item.dataCode} data-name={item.dataName} data-itemsize={item.dataItemsize} data-itemcolor={item.dataItemcolor} data-quantity='' data-remarks='' />
